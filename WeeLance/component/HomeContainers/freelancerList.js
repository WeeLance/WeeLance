              ...
              return ( 
                ...
                >
                  ...
                  <View style={{ justifyContent: 'center' }}>
                    ...
                    <Text style={{fontSize: 18, opacity: .7 ,  color: '#1c2765' , marginLeft: SPACING / 2,}}> {item.jobTitle}</Text>
                    <Text style={{ fontSize:12    , opacity: .8 , color: '#1c2765' ,   marginLeft: SPACING / 2,}}> {item.email}</Text> 
                  </View>
                </Animated.View> 
                </Pressable>
              );
