...
import {  IconButton, Icon, Button, Modal, Stack, FormControl, Input, Center, NativeBaseProvider,Text } from "native-base";
let  Example = () => {
    ...
    return <>
        ...
        <Modal isOpen={open} onClose={() => setOpen(false)} safeAreaTop={true}>
          <Modal.Content maxWidth="380" {...styles[placement]}>
            <Modal.CloseButton />
            <Modal.Header ><Center><Text color={'#F14E24'} >personal Information</Text></Center></Modal.Header>
            <Modal.Body>
              <FormControl>
            ...
            <Modal.Footer>
              <Button.Group space={2}>
                ...
                <Button backgroundColor={'#F14E24'} onPress={() => {
                setOpen(false);
              }}>
                  Save
                </Button>
