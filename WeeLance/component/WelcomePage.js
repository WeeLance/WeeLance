  ...
  const addUser = (idP, emailp) => {
    if (role === 'client') {
      ...
      axios
        ...
        .post(`http://192.168.169.52:5000/client/addClient`, {
          client_id: idP,
          name: name,
          email: emailp,
        })
      ...
      axios
        ...
        .post(`http://192.168.169.52:5000/freelancer/addFreelancer`, {
          freelancer_id: idP,
          name: name,
          email: emailp,
        })
      ...
      createUserWithEmailAndPassword(auth, email, password)
        ...
        .then(async (user) => {
          ...
          axios
            ...
            .get(`http://192.168.169.52:5000/freelancer/getOne/${user.uid}`)
          ...
          axios
            ...
            .get(`http://192.168.169.52:5000/client/getOne/${user.uid}`)
