...
export default function AddProject() {
  ...
  // const add =()=>{
  //   axios.post(`http://192.168.43.145:5000/project/addProject`,{project_name: name,project_category : category,project_description : description, client_id :id})
  ...
  const add = () => {
    axios
      .post(`http://192.168.43.145:5000/project/addProject`, {
        project_name: name,
