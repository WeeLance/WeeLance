...
const add =()=>{  
  axios.post(`http://192.168.103.2:5000/project/addProject`,{project_name: name,project_category : category,project_description : description, client_id :id})
   ...
   <Center>
      <Box maxW="300">
        ...
        endIcon: <CheckIcon size="5" />
          ...
          <Select.Item label="Graphic & Design" value="Graphic & Design" />
          <Select.Item label="Digital Marketing" value="Digital Marketing" />
          <Select.Item label="Programing & Tech" value="Programing & Tech" />
          <Select.Item label="Video & Animation" value="Video & Animation" />
          ...
          <Select.Item label="Business" value="Business" />
              ...
              <Center> 
              <Button onPress={()=>{add()}}> add project </Button>
